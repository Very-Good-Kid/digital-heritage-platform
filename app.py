        ...
        if platform == '微信':
            steps = [
                ...
                },
                {
                    'step': 2,
                    'title': '办理继承权公证',
                    'description': '材料齐全且无误后，前往公证处办理。（详见：《公证处办理流程》）',
                    'materials': [
...
def download_inheritance_template(template_name):
    ...
    # 模板文件映射
    template_map = {
        'QQ数字遗产明细清单模板': 'QQ数字遗产明细清单模板.pdf',
        'QQ数字遗产继承客服沟通标准话术模板': 'QQ数字遗产继承客服沟通标准话术模板.pdf',
        'QQ数字遗产继承正式申请表': 'QQ数字遗产继承正式申请表.pdf',
        'QQ数字遗产法定继承申请表': 'QQ数字遗产法定继承申请表.pdf',
        'QQ平台法定继承场景客服沟通标准话术模板': 'QQ平台法定继承场景客服沟通标准话术模板.pdf',
        '微信数字遗产明细清单模板': '微信数字遗产明细清单模板.pdf',
        '微信数字遗产继承客服沟通标准话术模板': '微信数字遗产继承客服沟通标准话术模板.pdf',
        '微信数字遗产继承正式申请表': '微信数字遗产继承正式申请表.pdf',
        '微信数字遗产法定继承申请表': '微信数字遗产法定继承申请表.pdf',
        '微信平台法定继承场景客服沟通标准话术模板': '微信平台法定继承场景客服沟通标准话术模板.pdf',
        '抖音数字遗产明细清单模板': '抖音数字遗产明细清单模板.pdf',
        '抖音数字遗产继承客服沟通标准话术模板': '抖音数字遗产继承客服沟通标准话术模板.pdf',
        '抖音数字遗产继承正式申请表': '抖音数字遗产继承正式申请表.pdf',
        '抖音数字遗产法定继承申请表': '抖音数字遗产法定继承申请表.pdf',
        '抖音平台法定继承场景客服沟通标准话术模板': '抖音平台法定继承场景客服沟通标准话术模板.pdf',
        '自书数字遗嘱合规参考模板': '自书数字遗嘱合规参考模板.pdf',
        '继承申请材料整理封面与目录模板': '继承申请材料整理封面与目录模板.pdf',
        '继承申请材料补正说明模板': '继承申请材料补正说明模板.pdf',
        '数字遗产继承纠纷律师函模板': '数字遗产继承纠纷律师函模板.pdf',
        '遗嘱继承纠纷民事起诉状模板': '遗嘱继承纠纷民事起诉状模板.pdf',
        '数字遗产继承纠纷证据清单整理模板': '数字遗产继承纠纷证据清单整理模板.pdf',
        '法定继承纠纷民事起诉状模板': '法定继承纠纷民事起诉状模板.pdf',
        '法定继承亲属关系证明办理指引模板': '法定继承亲属关系证明办理指引模板.pdf',
        '多继承人继承分配方案与授权委托书模板': '多继承人继承分配方案与授权委托书模板.pdf'
    }
...
def initialize_sample_data():
    ...
    if PlatformPolicy.query.count() > 0:
        ...
        all_faqs = [
            FAQ(
                question='什么是数字遗产？',
                answer='数字遗产是指个人在数字世界中留下的所有资产和数据，包括：社交媒体账号（微信、QQ、微博等）、电子邮箱、云存储文件、数字货币（比特币、游戏币等）、虚拟财产（游戏装备、域名等）、数字内容（照片、视频、文档等）。这些资产具有经济价值和情感价值，需要妥善处理。',
                category='基础概念',
                order=1
            ),
            FAQ(
